<?php
namespace App\Http\Providers\Gas\BinanceSmartChain;
...
{
    const SUPPORTED_NETWORK_ID = 56;
    const PROVIDER_NAME = "Bscscan";
    ...
    public function getDataFromApi(): Consumer
    {
        ...
        try {
            $res = $client->request(
                'GET', 
                "?module=gastracker&action=gasoracle&apikey=". env("PROVIDER_TX_BSC_API_KEY", "NO_API_KEY")
            );
